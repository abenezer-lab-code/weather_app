...
return (
 ...
 <div style={{background: isLoading &&"hsl(243, 27%, 20%)"}}  className={`p-5 grid items-center mb-2 rounded-2xl sm:bg-[url("../assets/images/bg-today-large.svg")] bg-[url("../assets/images/bg-today-small.svg")]  bg-no-repeat bg-cover`}>
